...
class HeadOffsetLoss(nn.Module):
    def __init__(self, loss_weight):
        super(HeadOffsetLoss, self).__init__()
    ...
    def forward(self, pred, target):
        ...
        loss_head_offset = self.loss_weight * torch.sum(smooth_l1_loss) / pos_offset_nums
        return loss_head_offset
