...
class GenCaltech(object):
    def __init__(self):
        self.root_dir = '/home/lyw/wzc/CSP/CSP-pedestrian-pytorch-master/Caltech/train'
        ...
        self.res_path_gt = '/home/lyw/wzc/CSP/CSP-pedestrian-pytorch-master/data/cache/caltech/train_gt'
        self.res_path_nogt = '/home/lyw/wzc/CSP/CSP-pedestrian-pytorch-master/data/cache/caltech/train_nogt'
        self.rows = 480
        self.cols = 640
        self.image_data_gt = []
