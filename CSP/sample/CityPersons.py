...
def kp_detection(cfg, ped_data, k_ind):
    batch_size = cfg.batch_size
    size_train = cfg.size_train_city
    ...
    for b_ind in range(0, batch_size):
...
def sample_data(cfg, ped_data, k_ind):
    return globals()[cfg.sampling_function](cfg, ped_data, k_ind)
