...
class SingleStageDetector(nn.Module):
    ...
    def loss(self, preds, targets):
        preds_csp = preds
        seman_map, scale_map, offset_map, head_map = targets[0], targets[1], targets[2], targets[3]
        losses_csp = self.csp_head.loss(preds_csp, seman_map=seman_map, scale_map=scale_map, offset_map=offset_map, head_map=head_map)
