...
from models.losses import CSPCenterLoss, RegrHLoss, RegrOffsetLoss, HeadCenterLoss
...
class KpHead(nn.Module):
    ...
    def forward(self, inputs):
        ...
        return [x_class, x_regr, x_offset, x_class2]
    ...
    def loss(self,
             ...
             offset_map,
             head_map):
        cls_pred, regr_pred, offset_pred, cls_pred2 = preds[0], preds[1], preds[2], preds[3]
        ...
        loss_cls2 = self.head_center_loss(cls_pred2, head_map)
        return dict(loss_cls=loss_cls, loss_regr=loss_regr, loss_offset=loss_offset, loss_cls2=loss_cls2)
