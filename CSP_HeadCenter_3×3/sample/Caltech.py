...
def kp_detection(cfg, ped_data, k_ind, emp_data, ngt_ind):
    ...
    x_img_batch, y_seman_batch, y_height_batch, y_offset_batch, y_head_batch = [], [], [], [], []
    ...
    for b_ind in range(0, batchsize_ped):
        ...
        y_seman, y_height, y_offset, y_head = calc_gt_center(size_train, img_data_aug)
    ...
    return {
        "xs": [x_img_batch],
        "ys": [y_seman_batch, y_height_batch, y_offset_batch, y_head_batch]
    }, k_ind, ngt_ind
