...
class GenCaltech(object):
    def __init__(self):
        self.root_dir = '/home/cvlab/Data/wzc/CSP/CSP_copy/Caltech/train'
        ...
        self.res_path_gt = '/home/cvlab/Data/wzc/CSP/CSP_copy/data/cache/caltech/train_gt'
        self.res_path_nogt = '/home/cvlab/Data/wzc/CSP/CSP_copy/data/cache/caltech/train_nogt'
        self.rows = 480
        self.cols = 640
        self.image_data_gt = []
